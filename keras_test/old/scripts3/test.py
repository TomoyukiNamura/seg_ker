...
target_milage_id_list = range(1480,1580)
...
# 原系列の前処理：移動平均
org_dict["raw0_prior_treated"], tmp_raw0_median, tmp_raw0_median_diff  = prior_funcs.priorRawData(df_raw=org_dict["raw0"], window=window, min_periods=min_periods,
                                                                                                    center=center, tol_diff=0.7, tol_n_group=5, 
                                                                                                    window_median=3)


# 原系列前処理結果の保存
folder_name = "output_test/movie_prior2"
