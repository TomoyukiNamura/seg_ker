...
import os
os.chdir("/Users/tomoyuki/python_workspace/train_conte")
os.getcwd()
...
#    df_irregularity_phase_modified = deepcopy(org_df_irregularity_phase_modified.iloc[:,target_milage_id_list])
    ...
    shutil.copyfile("honban.py", f"{output_pass}/scripts/honban.py")
    shutil.copyfile("finalize_result.py", f"{output_pass}/scripts/finalize_result.py")
    
    # ファンクション
    makeNewFolder(f"{output_pass}/scripts/func")
    shutil.copyfile("func/prior_funcs.py", f"{output_pass}/scripts/func/prior_funcs.py")
    shutil.copyfile("func/model_funcs.py", f"{output_pass}/scripts/func/model_funcs.py")
    shutil.copyfile("func/post_funcs.py", f"{output_pass}/scripts/func/post_funcs.py")
    
    # コンフィグ
    makeNewFolder(f"{output_pass}/scripts/conf")
    shutil.copyfile(f"conf/track_{track}.ini", f"{output_pass}/scripts/conf/track_{track}.ini")
